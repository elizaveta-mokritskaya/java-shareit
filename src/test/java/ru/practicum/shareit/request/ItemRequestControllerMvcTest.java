...
class ItemRequestControllerMvcTest {
    ...
    void getRequestByIdTest_returnItemRequestInfoDto() throws Exception {
        Item item1 = new Item(1L, "item1", "description1", Status.AVAILABLE, userToCheck2, request1);
        Item item2 = new Item(2L, "item2", "description2", Status.AVAILABLE, userToCheck2, request1);
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.description").value("запрос1"))
                .andExpect(jsonPath("$.created").value("2024-03-01T12:00:00"))
                .andExpect(jsonPath("$.itemList.[0].id").value(1))
                .andExpect(jsonPath("$.itemList.[0].name").value("item1"))
                .andExpect(jsonPath("$.itemList.[0].description").value("description1"))
                .andExpect(jsonPath("$.itemList.[0].available").value("true"))
                .andExpect(jsonPath("$.itemList.[0].owner.id").value(2))
                .andExpect(jsonPath("$.itemList.[0].owner.email").value("user2@mail.ru"))
                .andExpect(jsonPath("$.itemList.[0].owner.name").value("user2"))
                .andExpect(jsonPath("$.itemList.[0].requestId").value(1))
                .andExpect(jsonPath("$.itemList.[1].id").value(2L))
                .andExpect(jsonPath("$.itemList.[1].name").value("item2"))
                .andExpect(jsonPath("$.itemList.[1].description").value("description2"))
                .andExpect(jsonPath("$.itemList.[1].available").value("true"))
                .andExpect(jsonPath("$.itemList.[1].owner.id").value(2))
                .andExpect(jsonPath("$.itemList.[1].owner.email").value("user2@mail.ru"))
                .andExpect(jsonPath("$.itemList.[1].owner.name").value("user2"))
                .andExpect(jsonPath("$.itemList.[1].requestId").value(1));
    }
}